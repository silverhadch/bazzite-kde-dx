...
if ! dnf5 install -y --skip-broken --skip-unavailable --allowerasing \
    git python3-dbus python3-pyyaml python3-setproctitle clang-devel kf6-kirigami-devel kf6-qqc2-desktop-style-devel kf6-kirigami-addons-devel clang-tools-extra 2>/tmp/dnf-error; then
